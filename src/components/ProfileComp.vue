...
.home-img .animation {
  ...
  filter: drop-shadow(0 0 12px rgba(0, 255, 238, 0.4));
  border-radius: 50%;
  z-index: -1;
  animation: rotate_profile 8s linear infinite;
}

@keyframes rotate_profile {
  0% {
    rotate: 360deg;
  }
...
.home-img img:hover {
  ...
  box-shadow: 0 0 50px rgba(0, 255, 238, 0.6);
}
